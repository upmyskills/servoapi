...
var _a = require('http-errors'), createError = _a[0], HttpError = _a[1];
var cors = require('cors');
var path = require('path');
var fetch = require('node-fetch');
var const_1 = require("./routes/const");
var load = function () { return __awaiter(void 0, void 0, void 0, function () {
    var response, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch('http://localhost:3001/pseudoserver/menu.json')];
            case 1:
                response = _a.sent();
...
load();
exports.app = express();
var port = config.get('serverConf.localport');
// view engine setup
...
exports.app.use(main_route_1.baseRoute);
